...
export default function About() {
  const values = [
    { n: '01', title: 'Excellence', text: 'La recherche permanente de la qualité dans tout ce que nous entreprenons.', img: '/images/gallery/img_6025_2.jpg' },
    { n: '02', title: 'Discipline', text: 'Le respect des règles et de soi-même comme moteur de progrès constant.', img: '/images/gallery/img_5922_2.jpg' },
    { n: '03', title: 'Intégrité', text: 'L\'honnêteté et la transparence au cœur de notre communauté scolaire.', img: '/images/gallery/img_5918_2.jpg' },
  ];

  const pillars = [
    { src: '/images/gallery/img_5791.jpg', label: 'Vie académique' },
    { src: '/images/gallery/img_5412.jpg', label: 'Jardin Vert' },
    { src: '/images/gallery/img_8346.jpg', label: 'Célébrations' },
    { src: '/images/gallery/img_5889_2.jpg', label: 'Nos élèves' },
  ];
              ...
              <FadeIn direction="right" className="col-span-12 lg:col-span-6">
                ...
                <div className="swiss-grid mt-10">
                  <div className="col-span-6 border-t border-ink pt-4">
                    <span className="numeral text-accent text-4xl">2004</span>
              ...
              <FadeIn direction="left" className="col-span-12 lg:col-span-6">
                <figure>
                  <div className="relative overflow-hidden rounded-lg border border-line group">
                    <motion.img
                      src="/images/gallery/img_5883_2.jpg"
                      alt="Collège Le Flambeau"
            ...
            <div className="swiss-grid">
              <FadeIn direction="up" delay={0.1} className="col-span-12 md:col-span-6">
                ...
                >
                  <div className="relative overflow-hidden" style={{ height: 'calc(var(--lh) * 9)' }}>
                    <img
                      src="/images/gallery/img_6033_2.jpg"
                      alt="Notre Vision"
              ...
              <FadeIn direction="up" delay={0.2} className="col-span-12 md:col-span-6">
                ...
                >
                  <div className="relative overflow-hidden" style={{ height: 'calc(var(--lh) * 9)' }}>
                    <img
                      src="/images/gallery/img_6007_2.jpg"
                      alt="Notre Mission"
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(17,19,21,.78), rgba(17,19,21,0))' }} />
