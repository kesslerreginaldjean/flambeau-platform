...
export default function Contact() {
  ...
  const coordonnees = [
    { icon: Phone, title: 'Téléphone', text: '+509 37347021', sub: 'Lundi – Vendredi, 8h – 16h' },
    { icon: Mail, title: 'Courriel', text: 'collegeleflambeaumedia@gmail.com', sub: 'Réponse sous 24h ouvrées' },
            ...
            <div className="swiss-grid">
              ...
              <FadeIn direction="left" className="col-span-12 md:col-span-5 mt-12 md:mt-0">
                ...
                <div className="aspect-square overflow-hidden border border-line rounded-lg">
                  <iframe
                    src="https://maps.google.com/maps?q=18.5502669,-72.3054691&t=&z=17&ie=UTF8&iwloc=&output=embed"
                    className="w-full h-full border-0"
                    loading="lazy"
                  ></iframe>
                </div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=18.5502669,-72.3054691"
                  target="_blank"
