...
export default function Activities() {
  const activities = [
    ...
    },
    {
      ...
      img: '/images/school_facade_wide.jpg',
    },
  ];

  const gallery = [
    { src: '/images/activity_conference.jpg', alt: 'Conférence', label: 'Conférences' },
    { src: '/images/activity_workshop.jpg', alt: 'Atelier', label: 'Ateliers' },
    { src: '/images/activity_students.jpg', alt: 'Élèves', label: 'Vie étudiante' },
    { src: '/images/activity_gala.jpg', alt: 'Gala', label: 'Gala annuel' },
  ];
