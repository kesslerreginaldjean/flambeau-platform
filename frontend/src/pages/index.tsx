...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      if (!hasSeen) setIsAnnouncementOpen(true);
    }, 2000);
    return () => clearTimeout(timer);
  }, []);

  const values = [
    { n: '01', title: 'Discipline', desc: 'Un cadre rigoureux pour forger le caractère.', img: '/images/school_values.jpg' },
    { n: '02', title: 'Excellence', desc: 'La quête perpétuelle du meilleur de soi-même.', img: '/images/school_vision.jpg' },
    { n: '03', title: 'Intégrité', desc: 'L’honnêteté au cœur de chaque action.', img: '/images/activity_students.jpg' },
    { n: '04', title: 'Innovation', desc: 'S’adapter aux défis du monde moderne.', img: '/images/activity_workshop.jpg' },
  ];
  ...
  const gallery = [
    { src: '/images/activity_gala.jpg', label: 'Gala annuel' },
    { src: '/images/activity_conference.jpg', label: 'Conférences' },
    { src: '/images/activity_workshop.jpg', label: 'Ateliers' },
    { src: '/images/activity_students.jpg', label: 'Vie étudiante' },
  ];
