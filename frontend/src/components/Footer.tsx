    ...
    <footer>
      <div className="container" style={{ paddingTop: 'calc(var(--lh) * 3)', paddingBottom: 'calc(var(--lh) * 2)' }}>
        <div className="swiss-grid">
          ...
          {cols.map((c) => (
            <nav key={c.head} className="col-span-6 md:col-span-3">
        ...
        <div className="swiss-grid mt-12 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,.12)' }}>
          ...
          <p className="col-span-6 md:col-span-3 mono text-xs text-white/50">+509 2813 1415</p>
          <p className="col-span-6 md:col-span-3 mono text-xs text-white/50">informations@collegeflambeau.edu</p>
        </div>
